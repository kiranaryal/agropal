                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        @csrf
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" placeholder="Email-Address" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number" type="text" Placeholder="Contact Number" class="form-control @error('number') is-invalid @enderror" name="number" value="{{ old('number') }}" required autocomplete="number" autofocus>
